...
from PyQt5.QtWidgets import QGroupBox, QWidget, QGridLayout, QLabel
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Group untuk groupCameraPreprocessingTop
        self.groupCameraPreprocessingTop = QGroupBox(self.centralWidget)
        self.groupCameraPreprocessingTop.setGeometry(QtCore.QRect(10, 10, 511, 401))
        self.groupCameraPreprocessingTop.setObjectName("groupCameraPreprocessingTop")

        # Mengatur widget gambar preprocessing top di dalam QGroupBox baru
        self.widgetImagePreprocessingTop = QLabel(self.groupCameraPreprocessingTop)
        self.widgetImagePreprocessingTop.setGeometry(QtCore.QRect(10, 60, 511, 401))
        self.widgetImagePreprocessingTop.setObjectName("widgetImagePreprocessingTop")

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.groupInit.setTitle(_translate("MainWindow", "Initialization"))
        self.bnClose.setText(_translate("MainWindow", "Turn off"))
        self.bnOpen.setText(_translate("MainWindow", "Turn on"))
        ...
        self.bnStop.setText(_translate("MainWindow", "Stop Collecting"))
        self.bnStart.setText(_translate("MainWindow", "Start Collecting"))
