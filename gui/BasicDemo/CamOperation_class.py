...
import cv2
import numpy as np
from anomalib.models.detection.spring_metal_detection import resize_image

from model import SpringMetalInspector
...
class CameraOperation:
    ...
    def __init__(self, obj_cam, st_device_list, n_connect_num=0, b_open_device=False, b_start_grabbing=False,
        ...
        self.model = SpringMetalInspector()
    ...
    def Work_thread(self, winHandle):
        ...
        while True:
            ...
            if 0 == ret:
                ...
                print("no data, ret = " + self.To_hex_str(self, ret))
                continue
            ...
            if PixelType_Gvsp_RGB8_Packed == self.st_frame_info.enPixelType:
                numArray = CameraOperation.Color_numpy(
                    self, buf_cache, self.st_frame_info.nWidth, self.st_frame_info.nHeight)
            else:
            ...
            if numArray is not None:
                ...
                numArray = self.model.predict(numArray, self.camera_ids[1])
                numArray = resize_image(numArray, width=1024)
